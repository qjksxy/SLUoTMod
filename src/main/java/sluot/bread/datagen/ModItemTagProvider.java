...
public class ModItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        getOrCreateTagBuilder(SLUTModTags.Items.CARD_LIST_ZOM)
                ...
                .add(ModItems.BOOK_8)
                .add(ModItems.BOOK_9)
                .add(ModItems.FOCUS_1)
                .add(ModItems.FOCUS_2)
                .add(ModItems.FOCUS_3)
                .add(ModItems.FOCUS_4)
                .add(ModItems.FOCUS_5)
                .add(ModItems.FOCUS_6)
                .add(ModItems.FOCUS_7)
                .add(ModItems.FOCUS_8)
                .add(ModItems.FOCUS_9);
